...
const CONSISTENCY_CHECKS_API_URL = 'http://35.182.58.232/consistency_check/checks';
const CONSISTENCY_UPDATE_API_URL = 'http://35.182.58.232/consistency_check/update';
