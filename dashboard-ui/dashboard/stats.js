...
const PROCESSING_STATS_API_URL = "http://3.96.198.236/processing/stats";
const CONSISTENCY_CHECK_API_URL = "http://3.96.198.236/consistency_check/checks";
...
const ANALYZER_API_URL = {
    ...
    energy_consumption: (index) => "http://3.96.198.236/analyzer/events/energy-consumption?index=${index}",
    solar_generation: (index) => "http://3.96.198.236/analyzer/events/solar-generation?index=${index}",
};
